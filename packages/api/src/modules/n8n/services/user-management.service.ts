...
export class UserManagementService {
  ...
  async inviteUser(admin: User, organizationId: string, inviteDto: InviteUserDto) {
  ...
  async updateUserRole(admin: User, organizationId: string, userId: string, updateDto: UpdateUserRoleDto) {
    await this.validateAdminAccess(admin, organizationId);
