...
export class WorkflowEventsGateway implements OnGatewayConnection, OnGatewayDisconnect {
  @WebSocketServer()
  ...
  handleUnsubscribeWorkflow(client: Socket & { user: User }, workflowId: string) {
